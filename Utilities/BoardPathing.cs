...
public class BoardPathing : MonoBehaviour
{
    ...
    private List<Vector2Int> SuccessorsFromPosition(Vector2Int pos){
        ...
        List<Vector2Int> posns = HexGridLayout.MainGrid.SuccessorsFromPosition(pos);

        // Ignore unmoveable
        posns.RemoveAll(thisPos => !GameController.MainGame.GetPositionTile(thisPos).movable);
    ...
    public void DrawSuccessorText(Vector2Int posn, float distance){
        ...
        Vector3 realPosn = HexGridLayout.GetPositionForHexFromCoord(posn);
